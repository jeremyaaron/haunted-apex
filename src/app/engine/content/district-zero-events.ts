...
export const DISTRICT_ZERO_EVENTS: readonly EventDefinition[] = [
  {
    ...
    choices: [
      ...
      },
      {
        ...
        contactId: 'contact_captain_hollis',
        contactEffects: { leverage: 3, trust: -2 },
        ledgerEffects: [
          {
            type: 'create',
    ...
    choices: [
      {
        ...
        contactEffects: { trust: -3, volatility: 3 },
        flags: ['owes_liaison'],
        ledgerEffects: [
          {
            type: 'create',
      ...
      },
      {
        ...
        effects: { intel: 7 },
        contactId: 'contact_veyra_lux',
        contactEffects: { trust: 2, exposure: 1 },
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        contactId: 'contact_veyra_lux',
        contactEffects: { leverage: 2, exposure: 2 },
      },
    ],
  },
  {
